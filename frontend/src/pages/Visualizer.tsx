    ...
    <div className="space-y-6">
      ...
      <div className="cyber-card space-y-4">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <h3 className="text-xs font-semibold text-cyan-700 dark:text-cyan-400 uppercase tracking-wider flex items-center gap-2">
            <Atom className="w-4 h-4" />
            <span>Pauli Eigenstate Explorer (Z, X, Y Bases)</span>
          </h3>
          <span className="text-xs text-slate-500 dark:text-slate-400 font-mono">2-Dimensional Hilbert Space ℂ²</span>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {states.map((st) => (
            <button
              ...
              className={`px-3.5 py-2 rounded-lg text-xs font-mono font-semibold transition-all shadow-sm ${
                selectedState === st.label
                  ? 'bg-cyan-500 text-slate-950 shadow-cyan-500/20'
                  : 'bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 dark:bg-slate-900 dark:text-slate-300 dark:border-slate-800 dark:hover:border-slate-700'
              }`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 dark:bg-slate-950/80 dark:border-slate-800 flex flex-col justify-between font-mono text-xs shadow-sm">
            <div className="space-y-2">
              <span className="text-slate-500 dark:text-slate-400 text-[11px] font-bold block">DIRAC FORMALISM & EIGENVALUES</span>
              <div className="p-3 rounded bg-white border border-slate-200 text-slate-900 dark:bg-slate-900 dark:border-slate-800 dark:text-slate-200 text-sm font-semibold shadow-inner">
            ...
            <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-500">
      ...
      <div className="cyber-card space-y-4">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <h3 className="text-xs font-semibold text-purple-700 dark:text-purple-400 uppercase tracking-wider flex items-center gap-2">
            <Sparkles className="w-4 h-4" />
            <span>Maximally Entangled Bell States (EPR Pairs in ℂ⁴)</span>
          </h3>
          <span className="text-xs text-slate-500 dark:text-slate-400 font-mono">Concurrence = 1.000 | Von Neumann Entropy = 1.000</span>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {bellStates.map((b) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs font-mono font-semibold transition-all shadow-sm ${
                selectedBell === b.name
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 dark:bg-slate-950/80 dark:border-slate-800 space-y-3 font-mono text-xs shadow-sm">
            <span className="text-slate-500 dark:text-slate-400 text-[11px] font-bold block">ENTANGLEMENT PROPERTIES</span>
            <div className="grid grid-cols-2 gap-2 text-center">
              <div className="p-2.5 rounded bg-white border border-slate-200 dark:bg-slate-900 dark:border-slate-800 shadow-sm">
                <span className="text-slate-500 block text-[10px]">Concurrence C(ψ)</span>
                <span className="text-purple-700 dark:text-purple-300 font-bold text-sm">1.000 (Maximal)</span>
              </div>
              <div className="p-2.5 rounded bg-white border border-slate-200 dark:bg-slate-900 dark:border-slate-800 shadow-sm">
                <span className="text-slate-500 block text-[10px]">Entanglement Entropy</span>
                <span className="text-cyan-700 dark:text-cyan-300 font-bold text-sm">1.000 e-bit</span>
              </div>
            </div>
      ...
      <div className="cyber-card space-y-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs font-mono">
          <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 dark:bg-slate-950 dark:border-slate-800 shadow-sm">
            <span className="text-cyan-700 dark:text-cyan-400 font-bold block mb-1">Pauli-X (Bit Flip)</span>
            <div className="text-slate-800 dark:text-slate-300 text-[11px] font-bold">[ [0, 1], [1, 0] ]</div>
            <span className="text-[10px] text-slate-500 mt-1 block">X|0⟩ = |1⟩, X|1⟩ = |0⟩</span>
          </div>

          <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 dark:bg-slate-950 dark:border-slate-800 shadow-sm">
            <span className="text-cyan-700 dark:text-cyan-400 font-bold block mb-1">Pauli-Z (Phase Flip)</span>
            <div className="text-slate-800 dark:text-slate-300 text-[11px] font-bold">[ [1, 0], [0, -1] ]</div>
            <span className="text-[10px] text-slate-500 mt-1 block">Z|0⟩ = |0⟩, Z|1⟩ = -|1⟩</span>
          </div>

          <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 dark:bg-slate-950 dark:border-slate-800 shadow-sm">
            <span className="text-cyan-700 dark:text-cyan-400 font-bold block mb-1">Pauli-Y</span>
            <div className="text-slate-800 dark:text-slate-300 text-[11px] font-bold">[ [0, -i], [i, 0] ]</div>
            <span className="text-[10px] text-slate-500 mt-1 block">Y = i·X·Z</span>
          </div>

          <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 dark:bg-slate-950 dark:border-slate-800 shadow-sm">
            <span className="text-cyan-700 dark:text-cyan-400 font-bold block mb-1">Hadamard (H)</span>
            <div className="text-slate-800 dark:text-slate-300 text-[11px] font-bold">1/√2 [ [1, 1], [1, -1] ]</div>
